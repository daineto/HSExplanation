...
(:action validate_91
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -99.499) 2) (^ (- x2 139.986) 2)) (^ 10 2) ) ; \phi_91
	)
	:effect (and
		(not (monitor_90))
		(monitor_91)
...
(:action validate_92
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -85.558) 2) (^ (- x2 120.563) 2)) (^ 10 2) ) ; \phi_92
	)
	:effect (and
		(not (monitor_91))
		(monitor_92)
...
(:action validate_93
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -74.191) 2) (^ (- x2 99.426) 2)) (^ 10 2) ) ; \phi_93
	)
	:effect (and
		(not (monitor_92))
		(monitor_93)
...
(:action validate_94
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -63.107) 2) (^ (- x2 78.139) 2)) (^ 10 2) ) ; \phi_94
	)
	:effect (and
		(not (monitor_93))
		(monitor_94)
...
(:action validate_95
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -52.365) 2) (^ (- x2 56.677) 2)) (^ 10 2) ) ; \phi_95
	)
	:effect (and
		(not (monitor_94))
		(monitor_95)
...
(:action validate_96
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -42.044) 2) (^ (- x2 35.01) 2)) (^ 10 2) ) ; \phi_96
	)
	:effect (and
		(not (monitor_95))
		(monitor_96)
...
(:action validate_97
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -32.521) 2) (^ (- x2 12.991) 2)) (^ 10 2) ) ; \phi_97
	)
	:effect (and
		(not (monitor_96))
		(monitor_97)
...
(:action validate_98
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -28.523) 2) (^ (- x2 -10.574) 2)) (^ 10 2) ) ; \phi_98
	)
	:effect (and
		(not (monitor_97))
		(monitor_98)
...
(:action validate_99
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -32.002) 2) (^ (- x2 -34.221) 2)) (^ 10 2) ) ; \phi_99
	)
	:effect (and
		(not (monitor_98))
		(monitor_99)
...
(:action validate_100
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -42.579) 2) (^ (- x2 -55.661) 2)) (^ 10 2) ) ; \phi_100
	)
	:effect (and
		(not (monitor_99))
		(monitor_100)
