...
(:event validate_71
	...
	:effect (and
		(not (monitor_70))
		(monitor_71)
		(increase (roughness) (+ (^ (- x1 665.613) 2) (^ (- x2 326.689) 2)))
	)
)
...
(:event validate_72
	...
	:effect (and
		(not (monitor_71))
		(monitor_72)
		(increase (roughness) (+ (^ (- x1 685.417) 2) (^ (- x2 317.318) 2)))
	)
)
...
(:event validate_73
	...
	:effect (and
		(not (monitor_72))
		(monitor_73)
		(increase (roughness) (+ (^ (- x1 701.356) 2) (^ (- x2 302.285) 2)))
	)
)
...
(:event validate_74
	...
	:effect (and
		(not (monitor_73))
		(monitor_74)
		(increase (roughness) (+ (^ (- x1 711.869) 2) (^ (- x2 283.062) 2)))
	)
)
...
(:event validate_75
	...
	:effect (and
		(not (monitor_74))
		(monitor_75)
		(increase (roughness) (+ (^ (- x1 715.928) 2) (^ (- x2 261.532) 2)))
	)
)
...
(:event validate_76
	...
	:effect (and
		(not (monitor_75))
		(monitor_76)
		(increase (roughness) (+ (^ (- x1 713.135) 2) (^ (- x2 239.801) 2)))
	)
)
...
(:event validate_77
	...
	:effect (and
		(not (monitor_76))
		(monitor_77)
		(increase (roughness) (+ (^ (- x1 703.764) 2) (^ (- x2 219.997) 2)))
	)
)
...
(:event validate_78
	...
	:effect (and
		(not (monitor_77))
		(monitor_78)
		(increase (roughness) (+ (^ (- x1 689.144) 2) (^ (- x2 203.61) 2)))
	)
)
...
(:event validate_79
	...
	:effect (and
		(not (monitor_78))
		(monitor_79)
		(increase (roughness) (+ (^ (- x1 673.652) 2) (^ (- x2 187.99) 2)))
	)
)
...
(:event validate_80
	...
	:effect (and
		(not (monitor_79))
		(monitor_80)
		(increase (roughness) (+ (^ (- x1 658.16) 2) (^ (- x2 172.37) 2)))
	)
)
...
(:event validate_81
	...
	:precondition (and
		...
		(< (+ (^ (- x1 642.649) 2) (^ (- x2 156.769) 2)) (^ 10 2) ) ; \phi_81
	)
	:effect (and
		(not (monitor_80))
		(monitor_81)
		(increase (roughness) (+ (^ (- x1 642.649) 2) (^ (- x2 156.769) 2)))
	)
)
...
(:event validate_82
	...
	:precondition (and
		...
		(< (+ (^ (- x1 627.489) 2) (^ (- x2 140.845) 2)) (^ 10 2) ) ; \phi_82
	)
	:effect (and
		(not (monitor_81))
		(monitor_82)
		(increase (roughness) (+ (^ (- x1 627.489) 2) (^ (- x2 140.845) 2)))
	)
)
...
(:event validate_83
	...
	:precondition (and
		...
		(< (+ (^ (- x1 616.832) 2) (^ (- x2 121.701) 2)) (^ 10 2) ) ; \phi_83
	)
	:effect (and
		(not (monitor_82))
		(monitor_83)
		(increase (roughness) (+ (^ (- x1 616.832) 2) (^ (- x2 121.701) 2)))
	)
)
...
(:event validate_84
	...
	:precondition (and
		...
		(< (+ (^ (- x1 612.613) 2) (^ (- x2 100.202) 2)) (^ 10 2) ) ; \phi_84
	)
	:effect (and
		(not (monitor_83))
		(monitor_84)
		(increase (roughness) (+ (^ (- x1 612.613) 2) (^ (- x2 100.202) 2)))
	)
)
...
(:event validate_85
	...
	:precondition (and
		...
		(< (+ (^ (- x1 615.243) 2) (^ (- x2 78.451) 2)) (^ 10 2) ) ; \phi_85
	)
	:effect (and
		(not (monitor_84))
		(monitor_85)
		(increase (roughness) (+ (^ (- x1 615.243) 2) (^ (- x2 78.451) 2)))
	)
)
...
(:event validate_86
	...
	:precondition (and
		...
		(< (+ (^ (- x1 624.467) 2) (^ (- x2 58.577) 2)) (^ 10 2) ) ; \phi_86
	)
	:effect (and
		(not (monitor_85))
		(monitor_86)
		(increase (roughness) (+ (^ (- x1 624.467) 2) (^ (- x2 58.577) 2)))
	)
)
...
(:event validate_87
	...
	:precondition (and
		...
		(< (+ (^ (- x1 639.38) 2) (^ (- x2 42.526) 2)) (^ 10 2) ) ; \phi_87
	)
	:effect (and
		(not (monitor_86))
		(monitor_87)
		(increase (roughness) (+ (^ (- x1 639.38) 2) (^ (- x2 42.526) 2)))
	)
)
...
(:event validate_88
	...
	:precondition (and
		...
		(< (+ (^ (- x1 658.523) 2) (^ (- x2 31.87) 2)) (^ 10 2) ) ; \phi_88
	)
	:effect (and
		(not (monitor_87))
		(monitor_88)
		(increase (roughness) (+ (^ (- x1 658.523) 2) (^ (- x2 31.87) 2)))
	)
)
...
(:event validate_89
	...
	:precondition (and
		...
		(< (+ (^ (- x1 679.986) 2) (^ (- x2 27.298) 2)) (^ 10 2) ) ; \phi_89
	)
	:effect (and
		(not (monitor_88))
		(monitor_89)
		(increase (roughness) (+ (^ (- x1 679.986) 2) (^ (- x2 27.298) 2)))
	)
)
...
(:event validate_90
	...
	:precondition (and
		...
		(< (+ (^ (- x1 701.779) 2) (^ (- x2 24.288) 2)) (^ 10 2) ) ; \phi_90
	)
	:effect (and
		(not (monitor_89))
		(monitor_90)
		(increase (roughness) (+ (^ (- x1 701.779) 2) (^ (- x2 24.288) 2)))
	)
)
...
(:event validate_91
	...
	:precondition (and
		...
		(< (+ (^ (- x1 723.534) 2) (^ (- x2 21.042) 2)) (^ 10 2) ) ; \phi_91
	)
	:effect (and
		(not (monitor_90))
		(monitor_91)
		(increase (roughness) (+ (^ (- x1 723.534) 2) (^ (- x2 21.042) 2)))
	)
)
...
(:event validate_92
	...
	:precondition (and
		...
		(< (+ (^ (- x1 743.962) 2) (^ (- x2 13.104) 2)) (^ 10 2) ) ; \phi_92
	)
	:effect (and
		(not (monitor_91))
		(monitor_92)
		(increase (roughness) (+ (^ (- x1 743.962) 2) (^ (- x2 13.104) 2)))
	)
)
...
(:event validate_93
	...
	:precondition (and
		...
		(< (+ (^ (- x1 763.35) 2) (^ (- x2 2.707) 2)) (^ 10 2) ) ; \phi_93
	)
	:effect (and
		(not (monitor_92))
		(monitor_93)
		(increase (roughness) (+ (^ (- x1 763.35) 2) (^ (- x2 2.707) 2)))
	)
)
...
(:event validate_94
	...
	:precondition (and
		...
		(< (+ (^ (- x1 782.738) 2) (^ (- x2 -7.691) 2)) (^ 10 2) ) ; \phi_94
	)
	:effect (and
		(not (monitor_93))
		(monitor_94)
		(increase (roughness) (+ (^ (- x1 782.738) 2) (^ (- x2 -7.691) 2)))
	)
)
...
(:event validate_95
	...
	:precondition (and
		...
		(< (+ (^ (- x1 802.126) 2) (^ (- x2 -18.088) 2)) (^ 10 2) ) ; \phi_95
	)
	:effect (and
		(not (monitor_94))
		(monitor_95)
		(increase (roughness) (+ (^ (- x1 802.126) 2) (^ (- x2 -18.088) 2)))
	)
)
...
(:event validate_96
	...
	:precondition (and
		...
		(< (+ (^ (- x1 821.528) 2) (^ (- x2 -28.459) 2)) (^ 10 2) ) ; \phi_96
	)
	:effect (and
		(not (monitor_95))
		(monitor_96)
		(increase (roughness) (+ (^ (- x1 821.528) 2) (^ (- x2 -28.459) 2)))
	)
)
...
(:event validate_97
	...
	:precondition (and
		...
		(< (+ (^ (- x1 840.932) 2) (^ (- x2 -38.826) 2)) (^ 10 2) ) ; \phi_97
	)
	:effect (and
		(not (monitor_96))
		(monitor_97)
		(increase (roughness) (+ (^ (- x1 840.932) 2) (^ (- x2 -38.826) 2)))
	)
)
...
(:event validate_98
	...
	:precondition (and
		...
		(< (+ (^ (- x1 860.337) 2) (^ (- x2 -49.193) 2)) (^ 10 2) ) ; \phi_98
	)
	:effect (and
		(not (monitor_97))
		(monitor_98)
		(increase (roughness) (+ (^ (- x1 860.337) 2) (^ (- x2 -49.193) 2)))
	)
)
...
(:event validate_99
	...
	:precondition (and
		...
		(< (+ (^ (- x1 879.715) 2) (^ (- x2 -59.607) 2)) (^ 10 2) ) ; \phi_99
	)
	:effect (and
		(not (monitor_98))
		(monitor_99)
		(increase (roughness) (+ (^ (- x1 879.715) 2) (^ (- x2 -59.607) 2)))
	)
)
...
(:event validate_100
	...
	:precondition (and
		...
		(< (+ (^ (- x1 896.654) 2) (^ (- x2 -73.503) 2)) (^ 10 2) ) ; \phi_100
	)
	:effect (and
		(not (monitor_99))
		(monitor_100)
		(increase (roughness) (+ (^ (- x1 896.654) 2) (^ (- x2 -73.503) 2)))
	)
)
