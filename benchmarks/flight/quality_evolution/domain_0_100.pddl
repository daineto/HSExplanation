...
(:event validate_81
	...
	:effect (and
		(not (monitor_80))
		(monitor_81)
		(increase (roughness) (+ (^ (- x1 64.597) 2) (^ (- x2 382.111) 2)))
	)
)
...
(:event validate_82
	...
	:effect (and
		(not (monitor_81))
		(monitor_82)
		(increase (roughness) (+ (^ (- x1 74.082) 2) (^ (- x2 364.564) 2)))
	)
)
...
(:event validate_83
	...
	:effect (and
		(not (monitor_82))
		(monitor_83)
		(increase (roughness) (+ (^ (- x1 88.308) 2) (^ (- x2 350.624) 2)))
	)
)
...
(:event validate_84
	...
	:effect (and
		(not (monitor_83))
		(monitor_84)
		(increase (roughness) (+ (^ (- x1 106.146) 2) (^ (- x2 341.762) 2)))
	)
)
...
(:event validate_85
	...
	:effect (and
		(not (monitor_84))
		(monitor_85)
		(increase (roughness) (+ (^ (- x1 125.85) 2) (^ (- x2 338.847) 2)))
	)
)
...
(:event validate_86
	...
	:effect (and
		(not (monitor_85))
		(monitor_86)
		(increase (roughness) (+ (^ (- x1 145.49) 2) (^ (- x2 342.163) 2)))
	)
)
...
(:event validate_87
	...
	:effect (and
		(not (monitor_86))
		(monitor_87)
		(increase (roughness) (+ (^ (- x1 163.144) 2) (^ (- x2 351.385) 2)))
	)
)
...
(:event validate_88
	...
	:effect (and
		(not (monitor_87))
		(monitor_88)
		(increase (roughness) (+ (^ (- x1 178.44) 2) (^ (- x2 364.266) 2)))
	)
)
...
(:event validate_89
	...
	:effect (and
		(not (monitor_88))
		(monitor_89)
		(increase (roughness) (+ (^ (- x1 195.512) 2) (^ (- x2 374.526) 2)))
	)
)
...
(:event validate_90
	...
	:effect (and
		(not (monitor_89))
		(monitor_90)
		(increase (roughness) (+ (^ (- x1 214.919) 2) (^ (- x2 379.007) 2)))
	)
)
...
(:event validate_91
	...
	:effect (and
		(not (monitor_90))
		(monitor_91)
		(increase (roughness) (+ (^ (- x1 234.761) 2) (^ (- x2 377.272) 2)))
	)
)
...
(:event validate_92
	...
	:effect (and
		(not (monitor_91))
		(monitor_92)
		(increase (roughness) (+ (^ (- x1 253.096) 2) (^ (- x2 369.491) 2)))
	)
)
...
(:event validate_93
	...
	:effect (and
		(not (monitor_92))
		(monitor_93)
		(increase (roughness) (+ (^ (- x1 268.129) 2) (^ (- x2 356.424) 2)))
	)
)
...
(:event validate_94
	...
	:effect (and
		(not (monitor_93))
		(monitor_94)
		(increase (roughness) (+ (^ (- x1 278.389) 2) (^ (- x2 339.352) 2)))
	)
)
...
(:event validate_95
	...
	:effect (and
		(not (monitor_94))
		(monitor_95)
		(increase (roughness) (+ (^ (- x1 282.87) 2) (^ (- x2 319.945) 2)))
	)
)
...
(:event validate_96
	...
	:effect (and
		(not (monitor_95))
		(monitor_96)
		(increase (roughness) (+ (^ (- x1 281.135) 2) (^ (- x2 300.103) 2)))
	)
)
...
(:event validate_97
	...
	:effect (and
		(not (monitor_96))
		(monitor_97)
		(increase (roughness) (+ (^ (- x1 273.354) 2) (^ (- x2 281.768) 2)))
	)
)
...
(:event validate_98
	...
	:effect (and
		(not (monitor_97))
		(monitor_98)
		(increase (roughness) (+ (^ (- x1 260.288) 2) (^ (- x2 266.735) 2)))
	)
)
...
(:event validate_99
	...
	:effect (and
		(not (monitor_98))
		(monitor_99)
		(increase (roughness) (+ (^ (- x1 243.267) 2) (^ (- x2 256.361) 2)))
	)
)
...
(:event validate_100
	...
	:effect (and
		(not (monitor_99))
		(monitor_100)
		(increase (roughness) (+ (^ (- x1 225.231) 2) (^ (- x2 247.718) 2)))
	)
)
