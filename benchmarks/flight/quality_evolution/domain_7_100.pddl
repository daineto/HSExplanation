...
(:event validate_81
	...
	:effect (and
		(not (monitor_80))
		(monitor_81)
		(increase (roughness) (+ (^ (- x1 74.443) 2) (^ (- x2 -217.048) 2)))
	)
)
...
(:event validate_82
	...
	:effect (and
		(not (monitor_81))
		(monitor_82)
		(increase (roughness) (+ (^ (- x1 62.348) 2) (^ (- x2 -235.316) 2)))
	)
)
...
(:event validate_83
	...
	:effect (and
		(not (monitor_82))
		(monitor_83)
		(increase (roughness) (+ (^ (- x1 45.2) 2) (^ (- x2 -248.954) 2)))
	)
)
...
(:event validate_84
	...
	:effect (and
		(not (monitor_83))
		(monitor_84)
		(increase (roughness) (+ (^ (- x1 24.677) 2) (^ (- x2 -256.624) 2)))
	)
)
...
(:event validate_85
	...
	:effect (and
		(not (monitor_84))
		(monitor_85)
		(increase (roughness) (+ (^ (- x1 2.788) 2) (^ (- x2 -257.577) 2)))
	)
)
...
(:event validate_86
	...
	:effect (and
		(not (monitor_85))
		(monitor_86)
		(increase (roughness) (+ (^ (- x1 -18.324) 2) (^ (- x2 -251.72) 2)))
	)
)
...
(:event validate_87
	...
	:effect (and
		(not (monitor_86))
		(monitor_87)
		(increase (roughness) (+ (^ (- x1 -36.593) 2) (^ (- x2 -239.625) 2)))
	)
)
...
(:event validate_88
	...
	:effect (and
		(not (monitor_87))
		(monitor_88)
		(increase (roughness) (+ (^ (- x1 -50.23) 2) (^ (- x2 -222.477) 2)))
	)
)
...
(:event validate_89
	...
	:effect (and
		(not (monitor_88))
		(monitor_89)
		(increase (roughness) (+ (^ (- x1 -57.901) 2) (^ (- x2 -201.953) 2)))
	)
)
...
(:event validate_90
	...
	:effect (and
		(not (monitor_89))
		(monitor_90)
		(increase (roughness) (+ (^ (- x1 -59.406) 2) (^ (- x2 -180.048) 2)))
	)
)
...
(:event validate_91
	...
	:effect (and
		(not (monitor_90))
		(monitor_91)
		(increase (roughness) (+ (^ (- x1 -59.672) 2) (^ (- x2 -158.05) 2)))
	)
)
...
(:event validate_92
	...
	:effect (and
		(not (monitor_91))
		(monitor_92)
		(increase (roughness) (+ (^ (- x1 -59.939) 2) (^ (- x2 -136.051) 2)))
	)
)
...
(:event validate_93
	...
	:effect (and
		(not (monitor_92))
		(monitor_93)
		(increase (roughness) (+ (^ (- x1 -60.006) 2) (^ (- x2 -114.056) 2)))
	)
)
...
(:event validate_94
	...
	:effect (and
		(not (monitor_93))
		(monitor_94)
		(increase (roughness) (+ (^ (- x1 -56.194) 2) (^ (- x2 -92.412) 2)))
	)
)
...
(:event validate_95
	...
	:effect (and
		(not (monitor_94))
		(monitor_95)
		(increase (roughness) (+ (^ (- x1 -51.689) 2) (^ (- x2 -70.878) 2)))
	)
)
...
(:event validate_96
	...
	:effect (and
		(not (monitor_95))
		(monitor_96)
		(increase (roughness) (+ (^ (- x1 -47.183) 2) (^ (- x2 -49.344) 2)))
	)
)
...
(:event validate_97
	...
	:effect (and
		(not (monitor_96))
		(monitor_97)
		(increase (roughness) (+ (^ (- x1 -42.678) 2) (^ (- x2 -27.811) 2)))
	)
)
...
(:event validate_98
	...
	:effect (and
		(not (monitor_97))
		(monitor_98)
		(increase (roughness) (+ (^ (- x1 -38.173) 2) (^ (- x2 -6.277) 2)))
	)
)
...
(:event validate_99
	...
	:effect (and
		(not (monitor_98))
		(monitor_99)
		(increase (roughness) (+ (^ (- x1 -33.668) 2) (^ (- x2 15.257) 2)))
	)
)
...
(:event validate_100
	...
	:effect (and
		(not (monitor_99))
		(monitor_100)
		(increase (roughness) (+ (^ (- x1 -29.163) 2) (^ (- x2 36.791) 2)))
	)
)
