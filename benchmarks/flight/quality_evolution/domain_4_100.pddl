...
(:event validate_91
	...
	:effect (and
		(not (monitor_90))
		(monitor_91)
		(increase (roughness) (+ (^ (- x1 -99.499) 2) (^ (- x2 139.986) 2)))
	)
)
...
(:event validate_92
	...
	:effect (and
		(not (monitor_91))
		(monitor_92)
		(increase (roughness) (+ (^ (- x1 -85.558) 2) (^ (- x2 120.563) 2)))
	)
)
...
(:event validate_93
	...
	:effect (and
		(not (monitor_92))
		(monitor_93)
		(increase (roughness) (+ (^ (- x1 -74.191) 2) (^ (- x2 99.426) 2)))
	)
)
...
(:event validate_94
	...
	:effect (and
		(not (monitor_93))
		(monitor_94)
		(increase (roughness) (+ (^ (- x1 -63.107) 2) (^ (- x2 78.139) 2)))
	)
)
...
(:event validate_95
	...
	:effect (and
		(not (monitor_94))
		(monitor_95)
		(increase (roughness) (+ (^ (- x1 -52.365) 2) (^ (- x2 56.677) 2)))
	)
)
...
(:event validate_96
	...
	:effect (and
		(not (monitor_95))
		(monitor_96)
		(increase (roughness) (+ (^ (- x1 -42.044) 2) (^ (- x2 35.01) 2)))
	)
)
...
(:event validate_97
	...
	:effect (and
		(not (monitor_96))
		(monitor_97)
		(increase (roughness) (+ (^ (- x1 -32.521) 2) (^ (- x2 12.991) 2)))
	)
)
...
(:event validate_98
	...
	:effect (and
		(not (monitor_97))
		(monitor_98)
		(increase (roughness) (+ (^ (- x1 -28.523) 2) (^ (- x2 -10.574) 2)))
	)
)
...
(:event validate_99
	...
	:effect (and
		(not (monitor_98))
		(monitor_99)
		(increase (roughness) (+ (^ (- x1 -32.002) 2) (^ (- x2 -34.221) 2)))
	)
)
...
(:event validate_100
	...
	:effect (and
		(not (monitor_99))
		(monitor_100)
		(increase (roughness) (+ (^ (- x1 -42.579) 2) (^ (- x2 -55.661) 2)))
	)
)
