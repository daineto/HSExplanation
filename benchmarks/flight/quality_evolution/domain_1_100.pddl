...
(:event validate_1
	...
	:effect (and
		(not (monitor_0))
		(monitor_1)
		(increase (roughness) (+ (^ (- x1 -5.87) 2) (^ (- x2 -23.169) 2)))
	)
)
...
(:event validate_2
	...
	:effect (and
		(not (monitor_1))
		(monitor_2)
		(increase (roughness) (+ (^ (- x1 -4.293) 2) (^ (- x2 -47.019) 2)))
	)
)
...
(:event validate_3
	...
	:effect (and
		(not (monitor_2))
		(monitor_3)
		(increase (roughness) (+ (^ (- x1 4.577) 2) (^ (- x2 -69.213) 2)))
	)
)
...
(:event validate_4
	...
	:effect (and
		(not (monitor_3))
		(monitor_4)
		(increase (roughness) (+ (^ (- x1 19.871) 2) (^ (- x2 -87.581) 2)))
	)
)
...
(:event validate_5
	...
	:effect (and
		(not (monitor_4))
		(monitor_5)
		(increase (roughness) (+ (^ (- x1 40.093) 2) (^ (- x2 -100.323) 2)))
	)
)
...
(:event validate_6
	...
	:effect (and
		(not (monitor_5))
		(monitor_6)
		(increase (roughness) (+ (^ (- x1 63.262) 2) (^ (- x2 -106.193) 2)))
	)
)
...
(:event validate_7
	...
	:effect (and
		(not (monitor_6))
		(monitor_7)
		(increase (roughness) (+ (^ (- x1 87.112) 2) (^ (- x2 -104.616) 2)))
	)
)
...
(:event validate_8
	...
	:effect (and
		(not (monitor_7))
		(monitor_8)
		(increase (roughness) (+ (^ (- x1 109.306) 2) (^ (- x2 -95.746) 2)))
	)
)
...
(:event validate_9
	...
	:effect (and
		(not (monitor_8))
		(monitor_9)
		(increase (roughness) (+ (^ (- x1 127.674) 2) (^ (- x2 -80.452) 2)))
	)
)
...
(:event validate_10
	...
	:effect (and
		(not (monitor_9))
		(monitor_10)
		(increase (roughness) (+ (^ (- x1 140.416) 2) (^ (- x2 -60.231) 2)))
	)
)
...
(:event validate_11
	...
	:effect (and
		(not (monitor_10))
		(monitor_11)
		(increase (roughness) (+ (^ (- x1 146.286) 2) (^ (- x2 -37.061) 2)))
	)
)
...
(:event validate_12
	...
	:effect (and
		(not (monitor_11))
		(monitor_12)
		(increase (roughness) (+ (^ (- x1 144.905) 2) (^ (- x2 -13.177) 2)))
	)
)
...
(:event validate_13
	...
	:effect (and
		(not (monitor_12))
		(monitor_13)
		(increase (roughness) (+ (^ (- x1 141.298) 2) (^ (- x2 10.55) 2)))
	)
)
...
(:event validate_14
	...
	:effect (and
		(not (monitor_13))
		(monitor_14)
		(increase (roughness) (+ (^ (- x1 137.691) 2) (^ (- x2 34.278) 2)))
	)
)
...
(:event validate_15
	...
	:effect (and
		(not (monitor_14))
		(monitor_15)
		(increase (roughness) (+ (^ (- x1 134.076) 2) (^ (- x2 58.004) 2)))
	)
)
...
(:event validate_16
	...
	:effect (and
		(not (monitor_15))
		(monitor_16)
		(increase (roughness) (+ (^ (- x1 130.431) 2) (^ (- x2 81.725) 2)))
	)
)
...
(:event validate_17
	...
	:effect (and
		(not (monitor_16))
		(monitor_17)
		(increase (roughness) (+ (^ (- x1 126.787) 2) (^ (- x2 105.447) 2)))
	)
)
...
(:event validate_18
	...
	:effect (and
		(not (monitor_17))
		(monitor_18)
		(increase (roughness) (+ (^ (- x1 123.085) 2) (^ (- x2 129.159) 2)))
	)
)
...
(:event validate_19
	...
	:effect (and
		(not (monitor_18))
		(monitor_19)
		(increase (roughness) (+ (^ (- x1 114.917) 2) (^ (- x2 151.621) 2)))
	)
)
...
(:event validate_20
	...
	:effect (and
		(not (monitor_19))
		(monitor_20)
		(increase (roughness) (+ (^ (- x1 100.207) 2) (^ (- x2 170.46) 2)))
	)
)
...
(:event validate_21
	...
	:effect (and
		(not (monitor_20))
		(monitor_21)
		(increase (roughness) (+ (^ (- x1 80.396) 2) (^ (- x2 183.831) 2)))
	)
)
...
(:event validate_22
	...
	:effect (and
		(not (monitor_21))
		(monitor_22)
		(increase (roughness) (+ (^ (- x1 57.422) 2) (^ (- x2 190.426) 2)))
	)
)
...
(:event validate_23
	...
	:effect (and
		(not (monitor_22))
		(monitor_23)
		(increase (roughness) (+ (^ (- x1 33.535) 2) (^ (- x2 189.599) 2)))
	)
)
...
(:event validate_24
	...
	:effect (and
		(not (monitor_23))
		(monitor_24)
		(increase (roughness) (+ (^ (- x1 11.073) 2) (^ (- x2 181.431) 2)))
	)
)
...
(:event validate_25
	...
	:effect (and
		(not (monitor_24))
		(monitor_25)
		(increase (roughness) (+ (^ (- x1 -7.766) 2) (^ (- x2 166.721) 2)))
	)
)
...
(:event validate_26
	...
	:effect (and
		(not (monitor_25))
		(monitor_26)
		(increase (roughness) (+ (^ (- x1 -21.137) 2) (^ (- x2 146.91) 2)))
	)
)
...
(:event validate_27
	...
	:effect (and
		(not (monitor_26))
		(monitor_27)
		(increase (roughness) (+ (^ (- x1 -27.732) 2) (^ (- x2 123.936) 2)))
	)
)
...
(:event validate_28
	...
	:effect (and
		(not (monitor_27))
		(monitor_28)
		(increase (roughness) (+ (^ (- x1 -27.417) 2) (^ (- x2 99.99) 2)))
	)
)
...
(:event validate_29
	...
	:effect (and
		(not (monitor_28))
		(monitor_29)
		(increase (roughness) (+ (^ (- x1 -25.608) 2) (^ (- x2 76.059) 2)))
	)
)
...
(:event validate_30
	...
	:effect (and
		(not (monitor_29))
		(monitor_30)
		(increase (roughness) (+ (^ (- x1 -23.798) 2) (^ (- x2 52.127) 2)))
	)
)
...
(:event validate_31
	...
	:effect (and
		(not (monitor_30))
		(monitor_31)
		(increase (roughness) (+ (^ (- x1 -21.989) 2) (^ (- x2 28.195) 2)))
	)
)
...
(:event validate_32
	...
	:effect (and
		(not (monitor_31))
		(monitor_32)
		(increase (roughness) (+ (^ (- x1 -20.475) 2) (^ (- x2 4.25) 2)))
	)
)
...
(:event validate_33
	...
	:effect (and
		(not (monitor_32))
		(monitor_33)
		(increase (roughness) (+ (^ (- x1 -24.509) 2) (^ (- x2 -19.309) 2)))
	)
)
...
(:event validate_34
	...
	:effect (and
		(not (monitor_33))
		(monitor_34)
		(increase (roughness) (+ (^ (- x1 -35.626) 2) (^ (- x2 -40.468) 2)))
	)
)
...
(:event validate_35
	...
	:effect (and
		(not (monitor_34))
		(monitor_35)
		(increase (roughness) (+ (^ (- x1 -52.737) 2) (^ (- x2 -57.156) 2)))
	)
)
...
(:event validate_36
	...
	:effect (and
		(not (monitor_35))
		(monitor_36)
		(increase (roughness) (+ (^ (- x1 -74.167) 2) (^ (- x2 -67.74) 2)))
	)
)
...
(:event validate_37
	...
	:effect (and
		(not (monitor_36))
		(monitor_37)
		(increase (roughness) (+ (^ (- x1 -97.819) 2) (^ (- x2 -71.183) 2)))
	)
)
...
(:event validate_38
	...
	:effect (and
		(not (monitor_37))
		(monitor_38)
		(increase (roughness) (+ (^ (- x1 -121.378) 2) (^ (- x2 -67.149) 2)))
	)
)
...
(:event validate_39
	...
	:effect (and
		(not (monitor_38))
		(monitor_39)
		(increase (roughness) (+ (^ (- x1 -142.537) 2) (^ (- x2 -56.033) 2)))
	)
)
...
(:event validate_40
	...
	:effect (and
		(not (monitor_39))
		(monitor_40)
		(increase (roughness) (+ (^ (- x1 -159.225) 2) (^ (- x2 -38.922) 2)))
	)
)
...
(:event validate_41
	...
	:effect (and
		(not (monitor_40))
		(monitor_41)
		(increase (roughness) (+ (^ (- x1 -169.809) 2) (^ (- x2 -17.491) 2)))
	)
)
...
(:event validate_42
	...
	:effect (and
		(not (monitor_41))
		(monitor_42)
		(increase (roughness) (+ (^ (- x1 -173.252) 2) (^ (- x2 6.161) 2)))
	)
)
...
(:event validate_43
	...
	:effect (and
		(not (monitor_42))
		(monitor_43)
		(increase (roughness) (+ (^ (- x1 -169.218) 2) (^ (- x2 29.719) 2)))
	)
)
...
(:event validate_44
	...
	:effect (and
		(not (monitor_43))
		(monitor_44)
		(increase (roughness) (+ (^ (- x1 -158.101) 2) (^ (- x2 50.878) 2)))
	)
)
...
(:event validate_45
	...
	:effect (and
		(not (monitor_44))
		(monitor_45)
		(increase (roughness) (+ (^ (- x1 -141.666) 2) (^ (- x2 68.329) 2)))
	)
)
...
(:event validate_46
	...
	:effect (and
		(not (monitor_45))
		(monitor_46)
		(increase (roughness) (+ (^ (- x1 -124.59) 2) (^ (- x2 85.194) 2)))
	)
)
...
(:event validate_47
	...
	:effect (and
		(not (monitor_46))
		(monitor_47)
		(increase (roughness) (+ (^ (- x1 -107.43) 2) (^ (- x2 101.97) 2)))
	)
)
...
(:event validate_48
	...
	:effect (and
		(not (monitor_47))
		(monitor_48)
		(increase (roughness) (+ (^ (- x1 -87.253) 2) (^ (- x2 114.783) 2)))
	)
)
...
(:event validate_49
	...
	:effect (and
		(not (monitor_48))
		(monitor_49)
		(increase (roughness) (+ (^ (- x1 -65.349) 2) (^ (- x2 124.592) 2)))
	)
)
...
(:event validate_50
	...
	:effect (and
		(not (monitor_49))
		(monitor_50)
		(increase (roughness) (+ (^ (- x1 -43.445) 2) (^ (- x2 134.401) 2)))
	)
)
...
(:event validate_51
	...
	:effect (and
		(not (monitor_50))
		(monitor_51)
		(increase (roughness) (+ (^ (- x1 -21.541) 2) (^ (- x2 144.21) 2)))
	)
)
...
(:event validate_52
	...
	:effect (and
		(not (monitor_51))
		(monitor_52)
		(increase (roughness) (+ (^ (- x1 0.363) 2) (^ (- x2 154.019) 2)))
	)
)
...
(:event validate_53
	...
	:effect (and
		(not (monitor_52))
		(monitor_53)
		(increase (roughness) (+ (^ (- x1 22.266) 2) (^ (- x2 163.831) 2)))
	)
)
...
(:event validate_54
	...
	:effect (and
		(not (monitor_53))
		(monitor_54)
		(increase (roughness) (+ (^ (- x1 44.155) 2) (^ (- x2 173.674) 2)))
	)
)
...
(:event validate_55
	...
	:effect (and
		(not (monitor_54))
		(monitor_55)
		(increase (roughness) (+ (^ (- x1 66.194) 2) (^ (- x2 183.149) 2)))
	)
)
...
(:event validate_56
	...
	:effect (and
		(not (monitor_55))
		(monitor_56)
		(increase (roughness) (+ (^ (- x1 89.777) 2) (^ (- x2 187.037) 2)))
	)
)
...
(:event validate_57
	...
	:effect (and
		(not (monitor_56))
		(monitor_57)
		(increase (roughness) (+ (^ (- x1 113.407) 2) (^ (- x2 183.448) 2)))
	)
)
...
(:event validate_58
	...
	:effect (and
		(not (monitor_57))
		(monitor_58)
		(increase (roughness) (+ (^ (- x1 134.772) 2) (^ (- x2 172.732) 2)))
	)
)
...
(:event validate_59
	...
	:effect (and
		(not (monitor_58))
		(monitor_59)
		(increase (roughness) (+ (^ (- x1 151.799) 2) (^ (- x2 155.954) 2)))
	)
)
...
(:event validate_60
	...
	:effect (and
		(not (monitor_59))
		(monitor_60)
		(increase (roughness) (+ (^ (- x1 166.51) 2) (^ (- x2 136.991) 2)))
	)
)
...
(:event validate_61
	...
	:effect (and
		(not (monitor_60))
		(monitor_61)
		(increase (roughness) (+ (^ (- x1 181.221) 2) (^ (- x2 118.028) 2)))
	)
)
...
(:event validate_62
	...
	:effect (and
		(not (monitor_61))
		(monitor_62)
		(increase (roughness) (+ (^ (- x1 195.932) 2) (^ (- x2 99.065) 2)))
	)
)
...
(:event validate_63
	...
	:effect (and
		(not (monitor_62))
		(monitor_63)
		(increase (roughness) (+ (^ (- x1 210.643) 2) (^ (- x2 80.102) 2)))
	)
)
...
(:event validate_64
	...
	:effect (and
		(not (monitor_63))
		(monitor_64)
		(increase (roughness) (+ (^ (- x1 225.353) 2) (^ (- x2 61.14) 2)))
	)
)
...
(:event validate_65
	...
	:effect (and
		(not (monitor_64))
		(monitor_65)
		(increase (roughness) (+ (^ (- x1 240.064) 2) (^ (- x2 42.177) 2)))
	)
)
...
(:event validate_66
	...
	:effect (and
		(not (monitor_65))
		(monitor_66)
		(increase (roughness) (+ (^ (- x1 255.407) 2) (^ (- x2 23.756) 2)))
	)
)
...
(:event validate_67
	...
	:effect (and
		(not (monitor_66))
		(monitor_67)
		(increase (roughness) (+ (^ (- x1 275.048) 2) (^ (- x2 10.136) 2)))
	)
)
...
(:event validate_68
	...
	:effect (and
		(not (monitor_67))
		(monitor_68)
		(increase (roughness) (+ (^ (- x1 297.937) 2) (^ (- x2 3.253) 2)))
	)
)
...
(:event validate_69
	...
	:effect (and
		(not (monitor_68))
		(monitor_69)
		(increase (roughness) (+ (^ (- x1 321.833) 2) (^ (- x2 3.78) 2)))
	)
)
...
(:event validate_70
	...
	:effect (and
		(not (monitor_69))
		(monitor_70)
		(increase (roughness) (+ (^ (- x1 345.138) 2) (^ (- x2 9.5) 2)))
	)
)
...
(:event validate_71
	...
	:effect (and
		(not (monitor_70))
		(monitor_71)
		(increase (roughness) (+ (^ (- x1 368.402) 2) (^ (- x2 15.396) 2)))
	)
)
...
(:event validate_72
	...
	:effect (and
		(not (monitor_71))
		(monitor_72)
		(increase (roughness) (+ (^ (- x1 391.666) 2) (^ (- x2 21.293) 2)))
	)
)
...
(:event validate_73
	...
	:effect (and
		(not (monitor_72))
		(monitor_73)
		(increase (roughness) (+ (^ (- x1 414.931) 2) (^ (- x2 27.19) 2)))
	)
)
...
(:event validate_74
	...
	:effect (and
		(not (monitor_73))
		(monitor_74)
		(increase (roughness) (+ (^ (- x1 438.195) 2) (^ (- x2 33.087) 2)))
	)
)
...
(:event validate_75
	...
	:effect (and
		(not (monitor_74))
		(monitor_75)
		(increase (roughness) (+ (^ (- x1 461.468) 2) (^ (- x2 38.947) 2)))
	)
)
...
(:event validate_76
	...
	:effect (and
		(not (monitor_75))
		(monitor_76)
		(increase (roughness) (+ (^ (- x1 484.658) 2) (^ (- x2 45.102) 2)))
	)
)
...
(:event validate_77
	...
	:effect (and
		(not (monitor_76))
		(monitor_77)
		(increase (roughness) (+ (^ (- x1 505.71) 2) (^ (- x2 56.42) 2)))
	)
)
...
(:event validate_78
	...
	:effect (and
		(not (monitor_77))
		(monitor_78)
		(increase (roughness) (+ (^ (- x1 522.234) 2) (^ (- x2 73.689) 2)))
	)
)
...
(:event validate_79
	...
	:effect (and
		(not (monitor_78))
		(monitor_79)
		(increase (roughness) (+ (^ (- x1 532.613) 2) (^ (- x2 95.22) 2)))
	)
)
...
(:event validate_80
	...
	:effect (and
		(not (monitor_79))
		(monitor_80)
		(increase (roughness) (+ (^ (- x1 535.831) 2) (^ (- x2 118.904) 2)))
	)
)
...
(:event validate_81
	...
	:effect (and
		(not (monitor_80))
		(monitor_81)
		(increase (roughness) (+ (^ (- x1 531.572) 2) (^ (- x2 142.423) 2)))
	)
)
...
(:event validate_82
	...
	:effect (and
		(not (monitor_81))
		(monitor_82)
		(increase (roughness) (+ (^ (- x1 520.254) 2) (^ (- x2 163.475) 2)))
	)
)
...
(:event validate_83
	...
	:effect (and
		(not (monitor_82))
		(monitor_83)
		(increase (roughness) (+ (^ (- x1 502.985) 2) (^ (- x2 179.999) 2)))
	)
)
...
(:event validate_84
	...
	:effect (and
		(not (monitor_83))
		(monitor_84)
		(increase (roughness) (+ (^ (- x1 481.454) 2) (^ (- x2 190.377) 2)))
	)
)
...
(:event validate_85
	...
	:effect (and
		(not (monitor_84))
		(monitor_85)
		(increase (roughness) (+ (^ (- x1 457.77) 2) (^ (- x2 193.595) 2)))
	)
)
...
(:event validate_86
	...
	:effect (and
		(not (monitor_85))
		(monitor_86)
		(increase (roughness) (+ (^ (- x1 434.251) 2) (^ (- x2 189.336) 2)))
	)
)
...
(:event validate_87
	...
	:effect (and
		(not (monitor_86))
		(monitor_87)
		(increase (roughness) (+ (^ (- x1 413.2) 2) (^ (- x2 178.019) 2)))
	)
)
...
(:event validate_88
	...
	:effect (and
		(not (monitor_87))
		(monitor_88)
		(increase (roughness) (+ (^ (- x1 396.645) 2) (^ (- x2 160.771) 2)))
	)
)
...
(:event validate_89
	...
	:effect (and
		(not (monitor_88))
		(monitor_89)
		(increase (roughness) (+ (^ (- x1 382.357) 2) (^ (- x2 141.488) 2)))
	)
)
...
(:event validate_90
	...
	:effect (and
		(not (monitor_89))
		(monitor_90)
		(increase (roughness) (+ (^ (- x1 368.069) 2) (^ (- x2 122.204) 2)))
	)
)
...
(:event validate_91
	...
	:effect (and
		(not (monitor_90))
		(monitor_91)
		(increase (roughness) (+ (^ (- x1 353.781) 2) (^ (- x2 102.921) 2)))
	)
)
...
(:event validate_92
	...
	:effect (and
		(not (monitor_91))
		(monitor_92)
		(increase (roughness) (+ (^ (- x1 339.493) 2) (^ (- x2 83.638) 2)))
	)
)
...
(:event validate_93
	...
	:effect (and
		(not (monitor_92))
		(monitor_93)
		(increase (roughness) (+ (^ (- x1 325.205) 2) (^ (- x2 64.354) 2)))
	)
)
...
(:event validate_94
	...
	:effect (and
		(not (monitor_93))
		(monitor_94)
		(increase (roughness) (+ (^ (- x1 310.902) 2) (^ (- x2 45.082) 2)))
	)
)
...
(:event validate_95
	...
	:effect (and
		(not (monitor_94))
		(monitor_95)
		(increase (roughness) (+ (^ (- x1 293.48) 2) (^ (- x2 28.719) 2)))
	)
)
...
(:event validate_96
	...
	:effect (and
		(not (monitor_95))
		(monitor_96)
		(increase (roughness) (+ (^ (- x1 271.854) 2) (^ (- x2 18.541) 2)))
	)
)
...
(:event validate_97
	...
	:effect (and
		(not (monitor_96))
		(monitor_97)
		(increase (roughness) (+ (^ (- x1 248.141) 2) (^ (- x2 15.544) 2)))
	)
)
...
(:event validate_98
	...
	:effect (and
		(not (monitor_97))
		(monitor_98)
		(increase (roughness) (+ (^ (- x1 224.663) 2) (^ (- x2 20.021) 2)))
	)
)
...
(:event validate_99
	...
	:effect (and
		(not (monitor_98))
		(monitor_99)
		(increase (roughness) (+ (^ (- x1 203.717) 2) (^ (- x2 31.535) 2)))
	)
)
...
(:event validate_100
	...
	:effect (and
		(not (monitor_99))
		(monitor_100)
		(increase (roughness) (+ (^ (- x1 187.354) 2) (^ (- x2 48.957) 2)))
	)
)
