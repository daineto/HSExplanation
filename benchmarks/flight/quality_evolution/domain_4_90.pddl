...
(:event validate_31
	...
	:effect (and
		(not (monitor_30))
		(monitor_31)
		(increase (roughness) (+ (^ (- x1 148.029) 2) (^ (- x2 692.805) 2)))
	)
)
...
(:event validate_32
	...
	:effect (and
		(not (monitor_31))
		(monitor_32)
		(increase (roughness) (+ (^ (- x1 126.23) 2) (^ (- x2 702.606) 2)))
	)
)
...
(:event validate_33
	...
	:effect (and
		(not (monitor_32))
		(monitor_33)
		(increase (roughness) (+ (^ (- x1 102.469) 2) (^ (- x2 705.192) 2)))
	)
)
...
(:event validate_34
	...
	:effect (and
		(not (monitor_33))
		(monitor_34)
		(increase (roughness) (+ (^ (- x1 79.072) 2) (^ (- x2 700.308) 2)))
	)
)
...
(:event validate_35
	...
	:effect (and
		(not (monitor_34))
		(monitor_35)
		(increase (roughness) (+ (^ (- x1 58.329) 2) (^ (- x2 688.433) 2)))
	)
)
...
(:event validate_36
	...
	:effect (and
		(not (monitor_35))
		(monitor_36)
		(increase (roughness) (+ (^ (- x1 42.271) 2) (^ (- x2 670.73) 2)))
	)
)
...
(:event validate_37
	...
	:effect (and
		(not (monitor_36))
		(monitor_37)
		(increase (roughness) (+ (^ (- x1 32.469) 2) (^ (- x2 648.931) 2)))
	)
)
...
(:event validate_38
	...
	:effect (and
		(not (monitor_37))
		(monitor_38)
		(increase (roughness) (+ (^ (- x1 29.884) 2) (^ (- x2 625.17) 2)))
	)
)
...
(:event validate_39
	...
	:effect (and
		(not (monitor_38))
		(monitor_39)
		(increase (roughness) (+ (^ (- x1 34.766) 2) (^ (- x2 601.772) 2)))
	)
)
...
(:event validate_40
	...
	:effect (and
		(not (monitor_39))
		(monitor_40)
		(increase (roughness) (+ (^ (- x1 42.209) 2) (^ (- x2 578.989) 2)))
	)
)
...
(:event validate_41
	...
	:effect (and
		(not (monitor_40))
		(monitor_41)
		(increase (roughness) (+ (^ (- x1 43.147) 2) (^ (- x2 555.106) 2)))
	)
)
...
(:event validate_42
	...
	:effect (and
		(not (monitor_41))
		(monitor_42)
		(increase (roughness) (+ (^ (- x1 36.659) 2) (^ (- x2 532.102) 2)))
	)
)
...
(:event validate_43
	...
	:effect (and
		(not (monitor_42))
		(monitor_43)
		(increase (roughness) (+ (^ (- x1 23.38) 2) (^ (- x2 512.229) 2)))
	)
)
...
(:event validate_44
	...
	:effect (and
		(not (monitor_43))
		(monitor_44)
		(increase (roughness) (+ (^ (- x1 4.61) 2) (^ (- x2 497.431) 2)))
	)
)
...
(:event validate_45
	...
	:effect (and
		(not (monitor_44))
		(monitor_45)
		(increase (roughness) (+ (^ (- x1 -17.814) 2) (^ (- x2 489.159) 2)))
	)
)
...
(:event validate_46
	...
	:effect (and
		(not (monitor_45))
		(monitor_46)
		(increase (roughness) (+ (^ (- x1 -41.409) 2) (^ (- x2 484.767) 2)))
	)
)
...
(:event validate_47
	...
	:effect (and
		(not (monitor_46))
		(monitor_47)
		(increase (roughness) (+ (^ (- x1 -65.005) 2) (^ (- x2 480.381) 2)))
	)
)
...
(:event validate_48
	...
	:effect (and
		(not (monitor_47))
		(monitor_48)
		(increase (roughness) (+ (^ (- x1 -88.6) 2) (^ (- x2 475.995) 2)))
	)
)
...
(:event validate_49
	...
	:effect (and
		(not (monitor_48))
		(monitor_49)
		(increase (roughness) (+ (^ (- x1 -112.196) 2) (^ (- x2 471.609) 2)))
	)
)
...
(:event validate_50
	...
	:effect (and
		(not (monitor_49))
		(monitor_50)
		(increase (roughness) (+ (^ (- x1 -135.137) 2) (^ (- x2 464.844) 2)))
	)
)
...
(:event validate_51
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -154.927) 2) (^ (- x2 451.441) 2)) (^ 10 2) ) ; \phi_51
	)
	:effect (and
		(not (monitor_50))
		(monitor_51)
		(increase (roughness) (+ (^ (- x1 -154.927) 2) (^ (- x2 451.441) 2)))
	)
)
...
(:event validate_52
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -169.606) 2) (^ (- x2 432.578) 2)) (^ 10 2) ) ; \phi_52
	)
	:effect (and
		(not (monitor_51))
		(monitor_52)
		(increase (roughness) (+ (^ (- x1 -169.606) 2) (^ (- x2 432.578) 2)))
	)
)
...
(:event validate_53
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -177.737) 2) (^ (- x2 410.102) 2)) (^ 10 2) ) ; \phi_53
	)
	:effect (and
		(not (monitor_52))
		(monitor_53)
		(increase (roughness) (+ (^ (- x1 -177.737) 2) (^ (- x2 410.102) 2)))
	)
)
...
(:event validate_54
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -178.589) 2) (^ (- x2 386.208) 2)) (^ 10 2) ) ; \phi_54
	)
	:effect (and
		(not (monitor_53))
		(monitor_54)
		(increase (roughness) (+ (^ (- x1 -178.589) 2) (^ (- x2 386.208) 2)))
	)
)
...
(:event validate_55
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -176.593) 2) (^ (- x2 362.291) 2)) (^ 10 2) ) ; \phi_55
	)
	:effect (and
		(not (monitor_54))
		(monitor_55)
		(increase (roughness) (+ (^ (- x1 -176.593) 2) (^ (- x2 362.291) 2)))
	)
)
...
(:event validate_56
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -174.597) 2) (^ (- x2 338.374) 2)) (^ 10 2) ) ; \phi_56
	)
	:effect (and
		(not (monitor_55))
		(monitor_56)
		(increase (roughness) (+ (^ (- x1 -174.597) 2) (^ (- x2 338.374) 2)))
	)
)
...
(:event validate_57
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -172.602) 2) (^ (- x2 314.457) 2)) (^ 10 2) ) ; \phi_57
	)
	:effect (and
		(not (monitor_56))
		(monitor_57)
		(increase (roughness) (+ (^ (- x1 -172.602) 2) (^ (- x2 314.457) 2)))
	)
)
...
(:event validate_58
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -170.606) 2) (^ (- x2 290.54) 2)) (^ 10 2) ) ; \phi_58
	)
	:effect (and
		(not (monitor_57))
		(monitor_58)
		(increase (roughness) (+ (^ (- x1 -170.606) 2) (^ (- x2 290.54) 2)))
	)
)
...
(:event validate_59
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -168.607) 2) (^ (- x2 266.624) 2)) (^ 10 2) ) ; \phi_59
	)
	:effect (and
		(not (monitor_58))
		(monitor_59)
		(increase (roughness) (+ (^ (- x1 -168.607) 2) (^ (- x2 266.624) 2)))
	)
)
...
(:event validate_60
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -165.741) 2) (^ (- x2 242.796) 2)) (^ 10 2) ) ; \phi_60
	)
	:effect (and
		(not (monitor_59))
		(monitor_60)
		(increase (roughness) (+ (^ (- x1 -165.741) 2) (^ (- x2 242.796) 2)))
	)
)
...
(:event validate_61
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -162.846) 2) (^ (- x2 218.971) 2)) (^ 10 2) ) ; \phi_61
	)
	:effect (and
		(not (monitor_60))
		(monitor_61)
		(increase (roughness) (+ (^ (- x1 -162.846) 2) (^ (- x2 218.971) 2)))
	)
)
...
(:event validate_62
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -159.919) 2) (^ (- x2 195.15) 2)) (^ 10 2) ) ; \phi_62
	)
	:effect (and
		(not (monitor_61))
		(monitor_62)
		(increase (roughness) (+ (^ (- x1 -159.919) 2) (^ (- x2 195.15) 2)))
	)
)
...
(:event validate_63
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -156.985) 2) (^ (- x2 171.33) 2)) (^ 10 2) ) ; \phi_63
	)
	:effect (and
		(not (monitor_62))
		(monitor_63)
		(increase (roughness) (+ (^ (- x1 -156.985) 2) (^ (- x2 171.33) 2)))
	)
)
...
(:event validate_64
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -154.052) 2) (^ (- x2 147.51) 2)) (^ 10 2) ) ; \phi_64
	)
	:effect (and
		(not (monitor_63))
		(monitor_64)
		(increase (roughness) (+ (^ (- x1 -154.052) 2) (^ (- x2 147.51) 2)))
	)
)
...
(:event validate_65
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -151.119) 2) (^ (- x2 123.69) 2)) (^ 10 2) ) ; \phi_65
	)
	:effect (and
		(not (monitor_64))
		(monitor_65)
		(increase (roughness) (+ (^ (- x1 -151.119) 2) (^ (- x2 123.69) 2)))
	)
)
...
(:event validate_66
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -148.186) 2) (^ (- x2 99.87) 2)) (^ 10 2) ) ; \phi_66
	)
	:effect (and
		(not (monitor_65))
		(monitor_66)
		(increase (roughness) (+ (^ (- x1 -148.186) 2) (^ (- x2 99.87) 2)))
	)
)
...
(:event validate_67
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -145.253) 2) (^ (- x2 76.05) 2)) (^ 10 2) ) ; \phi_67
	)
	:effect (and
		(not (monitor_66))
		(monitor_67)
		(increase (roughness) (+ (^ (- x1 -145.253) 2) (^ (- x2 76.05) 2)))
	)
)
...
(:event validate_68
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -142.32) 2) (^ (- x2 52.23) 2)) (^ 10 2) ) ; \phi_68
	)
	:effect (and
		(not (monitor_67))
		(monitor_68)
		(increase (roughness) (+ (^ (- x1 -142.32) 2) (^ (- x2 52.23) 2)))
	)
)
...
(:event validate_69
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -139.386) 2) (^ (- x2 28.41) 2)) (^ 10 2) ) ; \phi_69
	)
	:effect (and
		(not (monitor_68))
		(monitor_69)
		(increase (roughness) (+ (^ (- x1 -139.386) 2) (^ (- x2 28.41) 2)))
	)
)
...
(:event validate_70
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -139.012) 2) (^ (- x2 4.498) 2)) (^ 10 2) ) ; \phi_70
	)
	:effect (and
		(not (monitor_69))
		(monitor_70)
		(increase (roughness) (+ (^ (- x1 -139.012) 2) (^ (- x2 4.498) 2)))
	)
)
...
(:event validate_71
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -145.932) 2) (^ (- x2 -18.38) 2)) (^ 10 2) ) ; \phi_71
	)
	:effect (and
		(not (monitor_70))
		(monitor_71)
		(increase (roughness) (+ (^ (- x1 -145.932) 2) (^ (- x2 -18.38) 2)))
	)
)
...
(:event validate_72
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -159.583) 2) (^ (- x2 -37.999) 2)) (^ 10 2) ) ; \phi_72
	)
	:effect (and
		(not (monitor_71))
		(monitor_72)
		(increase (roughness) (+ (^ (- x1 -159.583) 2) (^ (- x2 -37.999) 2)))
	)
)
...
(:event validate_73
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -178.629) 2) (^ (- x2 -52.44) 2)) (^ 10 2) ) ; \phi_73
	)
	:effect (and
		(not (monitor_72))
		(monitor_73)
		(increase (roughness) (+ (^ (- x1 -178.629) 2) (^ (- x2 -52.44) 2)))
	)
)
...
(:event validate_74
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -201.205) 2) (^ (- x2 -60.289) 2)) (^ 10 2) ) ; \phi_74
	)
	:effect (and
		(not (monitor_73))
		(monitor_74)
		(increase (roughness) (+ (^ (- x1 -201.205) 2) (^ (- x2 -60.289) 2)))
	)
)
...
(:event validate_75
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -225.102) 2) (^ (- x2 -60.777) 2)) (^ 10 2) ) ; \phi_75
	)
	:effect (and
		(not (monitor_74))
		(monitor_75)
		(increase (roughness) (+ (^ (- x1 -225.102) 2) (^ (- x2 -60.777) 2)))
	)
)
...
(:event validate_76
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -247.979) 2) (^ (- x2 -53.857) 2)) (^ 10 2) ) ; \phi_76
	)
	:effect (and
		(not (monitor_75))
		(monitor_76)
		(increase (roughness) (+ (^ (- x1 -247.979) 2) (^ (- x2 -53.857) 2)))
	)
)
...
(:event validate_77
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -267.599) 2) (^ (- x2 -40.205) 2)) (^ 10 2) ) ; \phi_77
	)
	:effect (and
		(not (monitor_76))
		(monitor_77)
		(increase (roughness) (+ (^ (- x1 -267.599) 2) (^ (- x2 -40.205) 2)))
	)
)
...
(:event validate_78
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -282.04) 2) (^ (- x2 -21.16) 2)) (^ 10 2) ) ; \phi_78
	)
	:effect (and
		(not (monitor_77))
		(monitor_78)
		(increase (roughness) (+ (^ (- x1 -282.04) 2) (^ (- x2 -21.16) 2)))
	)
)
...
(:event validate_79
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -289.888) 2) (^ (- x2 1.416) 2)) (^ 10 2) ) ; \phi_79
	)
	:effect (and
		(not (monitor_78))
		(monitor_79)
		(increase (roughness) (+ (^ (- x1 -289.888) 2) (^ (- x2 1.416) 2)))
	)
)
...
(:event validate_80
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -290.376) 2) (^ (- x2 25.313) 2)) (^ 10 2) ) ; \phi_80
	)
	:effect (and
		(not (monitor_79))
		(monitor_80)
		(increase (roughness) (+ (^ (- x1 -290.376) 2) (^ (- x2 25.313) 2)))
	)
)
...
(:event validate_81
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -283.456) 2) (^ (- x2 48.191) 2)) (^ 10 2) ) ; \phi_81
	)
	:effect (and
		(not (monitor_80))
		(monitor_81)
		(increase (roughness) (+ (^ (- x1 -283.456) 2) (^ (- x2 48.191) 2)))
	)
)
...
(:event validate_82
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -270.051) 2) (^ (- x2 68.019) 2)) (^ 10 2) ) ; \phi_82
	)
	:effect (and
		(not (monitor_81))
		(monitor_82)
		(increase (roughness) (+ (^ (- x1 -270.051) 2) (^ (- x2 68.019) 2)))
	)
)
...
(:event validate_83
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -254.929) 2) (^ (- x2 86.656) 2)) (^ 10 2) ) ; \phi_83
	)
	:effect (and
		(not (monitor_82))
		(monitor_83)
		(increase (roughness) (+ (^ (- x1 -254.929) 2) (^ (- x2 86.656) 2)))
	)
)
...
(:event validate_84
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -239.521) 2) (^ (- x2 105.056) 2)) (^ 10 2) ) ; \phi_84
	)
	:effect (and
		(not (monitor_83))
		(monitor_84)
		(increase (roughness) (+ (^ (- x1 -239.521) 2) (^ (- x2 105.056) 2)))
	)
)
...
(:event validate_85
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -223.768) 2) (^ (- x2 123.162) 2)) (^ 10 2) ) ; \phi_85
	)
	:effect (and
		(not (monitor_84))
		(monitor_85)
		(increase (roughness) (+ (^ (- x1 -223.768) 2) (^ (- x2 123.162) 2)))
	)
)
...
(:event validate_86
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -207.533) 2) (^ (- x2 140.834) 2)) (^ 10 2) ) ; \phi_86
	)
	:effect (and
		(not (monitor_85))
		(monitor_86)
		(increase (roughness) (+ (^ (- x1 -207.533) 2) (^ (- x2 140.834) 2)))
	)
)
...
(:event validate_87
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -188.087) 2) (^ (- x2 154.731) 2)) (^ 10 2) ) ; \phi_87
	)
	:effect (and
		(not (monitor_86))
		(monitor_87)
		(increase (roughness) (+ (^ (- x1 -188.087) 2) (^ (- x2 154.731) 2)))
	)
)
...
(:event validate_88
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -165.298) 2) (^ (- x2 161.938) 2)) (^ 10 2) ) ; \phi_88
	)
	:effect (and
		(not (monitor_87))
		(monitor_88)
		(increase (roughness) (+ (^ (- x1 -165.298) 2) (^ (- x2 161.938) 2)))
	)
)
...
(:event validate_89
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -141.397) 2) (^ (- x2 161.75) 2)) (^ 10 2) ) ; \phi_89
	)
	:effect (and
		(not (monitor_88))
		(monitor_89)
		(increase (roughness) (+ (^ (- x1 -141.397) 2) (^ (- x2 161.75) 2)))
	)
)
...
(:event validate_90
	...
	:precondition (and
		...
		(< (+ (^ (- x1 -118.724) 2) (^ (- x2 154.186) 2)) (^ 10 2) ) ; \phi_90
	)
	:effect (and
		(not (monitor_89))
		(monitor_90)
		(increase (roughness) (+ (^ (- x1 -118.724) 2) (^ (- x2 154.186) 2)))
	)
)
